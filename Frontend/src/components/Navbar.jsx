          ...
          <header>
               <nav>
                    <div className="flex justify-between items-center  md:text-black px-4 md:px-10 lg:px-15 py-4 flex-wrap border-b-2 ">
                         ...
                         <BsSearch className=" relative right-2 text-lg md:hidden" />  {/* This is for mobile responsive search icon */}
                         ...
                         <Link to="/login">
                              <div className="border px-9 md:px-12 py-1 md:py-2 bg-white text-black md:text-white  md:bg-blue-600 md:hover:bg-transparent cursor-pointer border-blue-700 md:hover:border-blue-600 md:hover:bg-blue-700 md:hover:text-blue-600  rounded-lg md:block">
